...
export default function RequestPage() {
  const settings = {
    request_success_msg: "আপনার অনুরোধটি পাঠানো হয়েছে।",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 p-6">
      <div className="max-w-xl mx-auto">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-gray-400 mb-8 hover:text-red-600 transition-colors">
          <ArrowLeft className="w-4 h-4" /> ফিরে যান
        </Link>
        <h1 className="text-2xl font-black text-gray-900 dark:text-white mb-8">রক্তের অনুরোধ</h1>
