...
import { DISTRICTS, BLOOD_GROUPS } from "@/lib/geodata"; // বড় হাতের নামগুলো ব্যবহার করা হয়েছে
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      ...
      <main className="pb-20">
        ...
        <section className="relative z-10 -mt-8 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-4 md:gap-8 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl p-6 md:p-10 rounded-[2.5rem] shadow-2xl shadow-gray-200/50 dark:shadow-none border border-white dark:border-gray-800 text-center">
            {[
        ...
        <div className="space-y-32 mt-24">
          <section id="search" className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-black dark:text-white">{settings.search_section_title}</h2>
            </div>
          ...
          <section id="donor-form" className="max-w-3xl mx-auto px-4">
            <div className="bg-gradient-to-br from-red-600 to-rose-700 rounded-[3rem] p-8 md:p-12 text-white shadow-2xl shadow-red-500/20 relative overflow-hidden">
              <div className="relative z-10 text-center">
                ...
                <div className="bg-white dark:bg-gray-950 p-6 md:p-10 rounded-[2rem] text-gray-900">
          ...
          <section id="request-form" className="max-w-3xl mx-auto px-4">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-8 md:p-12 rounded-[3rem]">
      ...
      <footer className="bg-gray-50 dark:bg-gray-900 py-20 px-4 border-t border-gray-100 dark:border-gray-800 text-center">
